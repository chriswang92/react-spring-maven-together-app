  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Allows players to review a game’s history and see previous versions of
          a game’s board.
        </li>
        <li>
...
class Board extends React.Component {
  ...
  render() {
    ...
    var rows = [];
    const size =
      this.props.boardsize && this.props.boardsize <= 40
    ...
    for (let i = 0; i < size; i++) {
      ...
      for (let j = i * size; j < i * size + size; j++) {
        ...
        const color = {
          background:
            this.props.winner && this.props.winner[1].includes(j)
              ? 'yellow'
              : 'white'
        };
...
function WarningBanner(props) {
  ...
  return <div className="warning">Warning! Size over limit(40)!</div>;
}
